...
public class YamlStudentReader extends InputStream {
    DataInputStream inputStream;

    public YamlStudentReader(InputStream inputStream) {
        this.inputStream = new DataInputStream(inputStream);
    }

    public Student readStudent() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper(new YAMLFactory());
        Student student = objectMapper.readValue((InputStream) inputStream, Student.class);
        return student;
    }
