...
public class ClearFileBufferCommand extends AbstractCommand {
    public ClearFileBufferCommand(String path, Pattern regex, CommandExecutor executor) {
        super(path, regex, executor);
    }

    @Override
    public boolean execute() {
        return executor.startClearFileBuffer();
    }
}
